...
public class FriendListController {
    ...
    @GetMapping("/friends")
    public List<User> getFriendList(@RequestHeader("Authorization") String authHeader){
    ...
    @PostMapping("/friends")
    public ResponseEntity<String> createFriends(@RequestBody CreateFriendListDTO createFriendListDTO){
