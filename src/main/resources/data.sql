...
values (99990, 'Example1', 'Dummy1', false, 99992, 99990, 99992, 'FRIEND', NOW());

insert into friend_request_notification (id, title, message, view, friend_request_list_id, request_user_id, receipt_user_id, notification_type, created_at)
values (99994, 'Example2', 'Dummy2', false, 99994, 99994, 99990, 'FRIEND', NOW());

insert into friend_request_notification (id, title, message, view, friend_request_list_id, request_user_id, receipt_user_id, notification_type, created_at)
values (99995, 'Example3', 'Dummy3', true, 99995, 99995, 99990, 'FRIEND', NOW());